<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <span class="text-sm text-gray-500">Crea tus rutinas personalizadas</span>
        </div>
    </x-slot>
                        ...
                        <div class="pt-2">
                            ...
                            <div class="space-y-3">
                                @foreach($grouped as $catName => $items)
                                    <details class="rounded-2xl border border-gray-200 bg-gray-50/40">
                                ...
                                <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <form method="POST" action="{{ route('routines.destroy', $r) }}"
                                              onsubmit="return confirm('¿Borrar / Desuscribir la rutina?');">
                                            @csrf @method('DELETE')
                                    ...
                                    @foreach($r->exercises as $ex)
                                        <div class="rounded-2xl border border-gray-100 bg-gray-50 p-3">
                                            ...
                                            <p class="mt-1 text-xs text-gray-600">
                                                {{ $ex->pivot->target_sets }}x{{ $ex->pivot->target_reps }}
                                                · Descanso {{ $ex->pivot->rest_seconds }}s
                                            </p>
                                        </div>
                                    @endforeach
                                </div>
